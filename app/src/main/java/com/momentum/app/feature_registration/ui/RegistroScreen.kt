...
fun RegistroScreen(
    ...
    Column(
        ...
        Button(
            onClick = { navController.navigate(Routes.Contrato.name) },
            modifier = Modifier.fillMaxWidth()
        ) {
            Text(text = "Ver Términos y Condiciones")
        }
        
        // Mostrar error si no acepta términos
        ...
        Button(
            onClick = {
                if (viewModel.validarFormulario()) {
                    navController.navigate(route = Routes.Resumen.name)
                }
            },
            modifier = Modifier.fillMaxWidth()
        ) {
